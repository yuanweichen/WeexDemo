...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/yuanweichen/WeexDemo.git"
  ...
  s.source       = { :git => "https://github.com/yuanweichen/WeexDemo.git", :tag => s.version.to_s }
  ...
  s.source_files  = "WeexDemo/WeexDemo/**/*.{h,m,swift}"
